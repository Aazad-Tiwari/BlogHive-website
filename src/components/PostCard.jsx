...
function PostCard({ $id, title, featuredImage, time , truncatedContent }) {
    ...
    return (
        <div className='w-96 h-[600px] rounded-lg flex flex-col relative text-blog_black'>
            <img  src={appwriteService.getFilePreview(featuredImage)} alt="" className='w-[400px] h-[280px] bg-center object-cover relative rounded-lg' />
            <div className='overflow-auto h-[250px] mt-2 rounded-lg'>
